...
to pick up the new version. An older CLI refuses to replace a newer service
unless you add `--allow-downgrade`. Wait for any remote update already in
progress before updating; to match a remote client's version, follow
