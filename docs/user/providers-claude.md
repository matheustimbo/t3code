...
To also see the plan limits of every Claude account the hub pools, add the hub itself under
**Settings → Providers → Usage providers → Add hub**. See
[Connect a CLIProxyAPI hub](./usage.md#connect-a-cliproxyapi-hub).
