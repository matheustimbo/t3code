...
import { ProviderConcurrentSend } from "./provider.ts";
...
export const ServerProvider = Schema.Struct({
  ...
  // Optional because an older server does not send it. A client that does
  // not hear it has to say it cannot tell, rather than guess.
  concurrentSend: Schema.optional(ProviderConcurrentSend),
