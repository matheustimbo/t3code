...
import { TicketProviderBindings, TicketTitlePolicy } from "./ticketProvider.ts";
...
export const OrchestrationThreadShell = Schema.Struct({
  ...
  projectId: ProjectId,
  title: TrimmedNonEmptyString,
  // See OrchestrationThread.titleRevision: title generation compares against it
  // to avoid overwriting a title the user changed mid-generation, and the shell
  // is what the provider reactor reads on the first turn.
  titleRevision: Schema.optional(NonNegativeInt),
  modelSelection: ModelSelection,
  runtimeMode: RuntimeMode,
  interactionMode: ProviderInteractionMode.pipe(
...
const ThreadMetaUpdateCommand = Schema.Struct({
  ...
  expectedTitleRevision: Schema.optional(NonNegativeInt),
