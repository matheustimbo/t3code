...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    editQueuedMessage: createEnvironmentCommand(runtime, {
      ...
      execute: (input: EditQueuedMessageInput) => editQueuedMessage(input),
      scheduler,
      concurrency,
    }),
    dropQueuedMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:drop-queued-message",
      execute: (input: DropQueuedMessageInput) => dropQueuedMessage(input),
      scheduler,
      concurrency,
    }),
