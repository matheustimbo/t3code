...
// Reading and the schema live in shared so the desktop shell can discover a
// server that already owns its state directory. Writing stays here: it needs
// ServerConfig and the server's atomic-write helper.
export {
  isProcessAlive,
  PersistedServerRuntimeState,
