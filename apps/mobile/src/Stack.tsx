...
import { SettingsTicketProvidersRouteScreen } from "./features/settings/SettingsTicketProvidersRouteScreen";
...
const SettingsContentStack = createNativeStackNavigator({
  ...
  screens: {
    ...
    SettingsTicketProviders: createNativeStackScreen({
      screen: SettingsTicketProvidersRouteScreen,
      linking: "ticket-providers",
      options: {
