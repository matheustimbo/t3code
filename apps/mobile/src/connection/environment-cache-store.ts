...
// v4 discards snapshots written before server-side activity hydration was
// bounded. Those records can contain thousands of tool payloads and block the
// mobile JS thread before the live server has a chance to replace the cache.
